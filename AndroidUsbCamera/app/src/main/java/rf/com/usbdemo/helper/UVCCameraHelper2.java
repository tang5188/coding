...
public class UVCCameraHelper2 {
    public static final String ROOT_PATH = Environment.getExternalStorageDirectory().getAbsolutePath()
            + File.separator;
    public static final String SUFFIX_JPEG = ".jpg";
    public static final String SUFFIX_MP4 = ".mp4";
    private static final String TAG = "UVCCameraHelper2";
    ...
    private static UVCCameraHelper2 mCameraHelper;
    // USB Manager
    ...
    private UVCCameraHelper2() {
    }

    public static UVCCameraHelper2 getInstance() {
        if (mCameraHelper == null) {
            mCameraHelper = new UVCCameraHelper2();
        }
    ...
    public void initUSBMonitor(Activity activity, CameraViewInterface cameraView, final OnMyDevConnectListener listener) {
        ...
        mUSBMonitor = new USBMonitor(activity.getApplicationContext(), new USBMonitor.OnDeviceConnectListener() {
            ...
            public void onConnect(final UsbDevice device, USBMonitor.UsbControlBlock ctrlBlock, boolean createNew) {
                Log.i(TAG, "onConnect2" + device.getDeviceName());
