...
public class UVCCameraHelper1 {
    public static final String ROOT_PATH = Environment.getExternalStorageDirectory().getAbsolutePath()
            + File.separator;
    public static final String SUFFIX_JPEG = ".jpg";
    public static final String SUFFIX_MP4 = ".mp4";
    private static final String TAG = "UVCCameraHelper1";
    ...
    private static UVCCameraHelper1 mCameraHelper;
    // USB Manager
    ...
    private UVCCameraHelper1() {
    }

    public static UVCCameraHelper1 getInstance() {
        if (mCameraHelper == null) {
            mCameraHelper = new UVCCameraHelper1();
        }
